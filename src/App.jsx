...
//                       hasJoinedRoom={hasJoinedRoom} setHasJoinedRoom={setHasJoinedRoom} setRoomId={setRoomId} />
//           )
//         }
...
//           <div className="flex flex-col md:flex-row items-center justify-center space-x-4 w-full max-w-5xl bg-white shadow-xl rounded-lg p-6">
//             <div className="flex justify-between container space-x-20 w-full"> 
//             <Timer isTimerActive={isTimerActive} setisTimerActive={(isTimerActive) => isTimerActive ? startNewGame() : stopGame()} roomId={roomId} />
//               <div className="flex flex-col items-start w-1/2"> 
